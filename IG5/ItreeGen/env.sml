...
struct
  ...
  type access = Translate.access (* supposed to describe formals and locals that maybe in frame or reg *)
  type level = Translate.level (* depth of function *)
  type label = Temp.label (* names for abstract memory address *)
  type ty = T.ty
