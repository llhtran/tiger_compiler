...
struct
  ...
  fun unEx(Ex e) = Tr.ESEQ(Tr.EXP(Tr.CONST 0),e)
  (*fun unEx(Ex e) = e *)
...
(*        Ex(Tr.MEM(Tr.BINOP(Tr.PLUS,
        ...
        Ex(Tr.ESEQ(Tr.EXP(F.externalCall("recordNilCheck",[unEx mem])),
          (Tr.MEM(Tr.BINOP(Tr.PLUS,
                          ...
                          Tr.BINOP(Tr.MUL,unEx i,Tr.CONST F.ws)),
                  F.ws))))
(*        let val e1 = Tr.MEM(Tr.BINOP(Tr.PLUS, unEx mem, Tr.BINOP(Tr.MUL,unEx i,Tr.CONST F.ws)))
            val e2 = Tr.MEM(Tr.BINOP(Tr.PLUS, unEx mem, 
                            Tr.BINOP(Tr.MUL,
                            Tr.BINOP(Tr.MINUS,unEx i,Tr.CONST 1),Tr.CONST F.ws)))
        in Tr.
...
(* TODO: *)
  ...
  fun subsVar(mem, i) = 
    let val pi = unEx i (* process array sibscript value only once *)
        val pmem = unEx mem 
        val r = T.newtemp()
    in Ex(Tr.ESEQ(seq[Tr.MOVE(Tr.TEMP r, pi),
                  Tr.EXP(F.externalCall("arrayBounds",[pmem, pi]))],
                  Tr.MEM(Tr.BINOP(Tr.PLUS, pmem, Tr.BINOP(Tr.MUL,
                                                          Tr.BINOP(Tr.PLUS, Tr.TEMP r,Tr.CONST 1),
                                                          Tr.CONST F.ws)), 
                                  F.ws)))
    end
