...
int arrayBounds(int *a, int i)
{if (i<0 || i>=a[0]) DIE("Array subscript out of bounds.");}

int recordNilCheck(int *p)
{if (p==NULL) DIE("Record has a nil field.");}
